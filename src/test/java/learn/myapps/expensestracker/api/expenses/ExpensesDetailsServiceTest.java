...
class ExpensesDetailsServiceTest {
    ...
    void findAllPageNumberFail() {
        ...
        Assertions.assertEquals("Failed to get requested Expenses Details Entities from page number: 0", illegalArgumentException.getMessage());
    }
    ...
    void findAllPageSizeFail() {
        ...
        IllegalArgumentException illegalArgumentException = Assertions.assertThrows(IllegalArgumentException.class, () -> expensesDetailsService.findAll(0, 10, Sort.by("id")), "");
        Assertions.assertEquals("Failed to get requested Expenses Details Entities of page size: 10", illegalArgumentException.getMessage());
    }
    ...
    void findAllSortFail() {
        ...
        IllegalArgumentException illegalArgumentException = Assertions.assertThrows(IllegalArgumentException.class, () -> expensesDetailsService.findAll(0, 10, Sort.by("id")), "");
        Assertions.assertEquals("Failed to get requested Expenses Details Entities by sort: id: ASC", illegalArgumentException.getMessage());
    }
}
