...
CREATE OR REPLACE FUNCTION expenses_tracker.f_expenses_category_details() RETURNS TRIGGER AS '
    DECLARE
...
AFTER INSERT OR UPDATE OR DELETE ON expenses_tracker.expenses_category_details
    FOR EACH ROW EXECUTE FUNCTION expenses_tracker.f_expenses_category_details();