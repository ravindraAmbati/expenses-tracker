...
CREATE OR REPLACE FUNCTION expenses_tracker.f_payment_mode_details() RETURNS TRIGGER AS '
    DECLARE
...
AFTER INSERT OR UPDATE OR DELETE ON expenses_tracker.payment_mode_details
    FOR EACH ROW EXECUTE FUNCTION expenses_tracker.f_payment_mode_details();